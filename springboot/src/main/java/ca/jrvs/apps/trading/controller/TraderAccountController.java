...
public class TraderAccountController {
    ...
    @ApiOperation(value = "Delete a trader",
        notes = "Delete a trader if and only if its account amount is 0 and has no open positions. " +
        "Also delete the associated account(s) and securityOrders")
    ...
    @ApiOperation(value = "Withdraw a fund",
        notes = "Withdraw a fund from any account that associates with the traderId with sufficient funds." +
